...
//
$_CONFIG['main_title'] = "PHP Explorer";
...
//
$_CONFIG['hidden_files'] = array(".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd", "robots.txt", "log.txt");
...
//
$_CONFIG['users'] = array(array("admin", "admin", "admin"), array("guest", "guest", "user"));
...
$_TRANSLATIONS["es"] = array(
	...
	"root" => "Raíz",
	"log_file_permission_error" => "El script no tiene permisos para escribir el fichero de log.",
	"upload_not_allowed" => "El script de configuración no permite subir archivos en esta carpeta.",
	"upload_dir_not_writable" => "La carpeta no tiene permisos de escritura.",
	"mobile_version" => "Versión móvil",
	"standard_version" => "Versión escritorio",
	"page_load_time" => "Página cargada en %.2f ms",
	"wrong_pass" => "Nombre de usuario o password equivocado",
	"username" => "Usuario",
	"log_in" => "Log in",
	"upload_type_not_allowed" => "No está permitido subir este tipo de archivo.",
	"del" => "Borrar",
	"log_out" => "Log out"
);
...
#frame {
	border: 1px solid #888888; /*CDD2D6;*/
	text-align:left;
	position: relative;
	margin: 0 auto;
	max-width:680px;
...
/* Centramos icono Borrar */
table.table td.del img{
    display:block;
    margin:auto;
}
...
?>
<a href="http://descargas.ipereda.com" target="_blank\" >iPereda: Downloads Site</a>
</div>
<!-- END: Info area -->
</body>
</html>
